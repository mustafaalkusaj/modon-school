...
const DEFAULT_INCOME_DATE = todayBaghdadIso();
                      ...
                      <div className="flex items-center gap-2 flex-wrap flex-shrink-0">
                        ...
                        {!archiveMode.isArchiveMode && (
                          <motion.button
                            ...
                            onClick={() => {
                              if (activeTab === "invoices") { setEditIncome(null); setForm({ income_type_id: "", amount: "", income_date: todayBaghdadIso(), source: "", receipt_number: "", notes: "", receipt_image_url: null }); setShowIncomeForm(true); }
